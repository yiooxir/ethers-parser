...
describe('parser', () => {
    ...
    beforeEach(() => {
        ...
        parser = new parser_1.Parser(Object.assign(Object.assign({}, cfg), { provider }));
    });
    afterEach(() => {
        sandbox.restore();
    });
    ...
    it('Should  load transaction if @loadValue is true', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        parser = new parser_1.Parser(Object.assign(Object.assign({}, cfg), { provider, loadValue: true }));
        yield parser.parse(() => { });
    ...
    it('Should not load transaction from network only if param @loadValue is false ', () => __awaiter(void 0, void 0, void 0, function* () {
        const spy = provider.getTransaction;
        parser = new parser_1.Parser(Object.assign(Object.assign({}, cfg), { provider, loadValue: false }));
        yield parser.parse(() => { });
